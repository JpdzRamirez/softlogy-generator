            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="authModalLabel"><i class="fa-solid fa-right-to-bracket"></i> Authenticación</h5>
                ...
                <div class="modal-body softlogy-modal">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <span style="color: #fff" class="input-group-text bg-softlogy" id="authInputUser-addon"><i class="fa-solid fa-user"></i></span>
                            <input type="text" class="form-control" id="authInputUser" placeholder="Usuario" aria-label="Usuario" aria-describedby="authInputUser-addon">
                        </div>
                      ...
                      <div class="form-group">
                        <label for="authInputPassword">Contraseña</label>   
                          <div class="input-group mb-3">
                            <span style="color: #fff" class="input-group-text  bg-softlogy" id="authInput-addon"><i class="fa-solid fa-key"></i></span>
                            <input type="password" class="form-control" id="authInputPassword" placeholder="Contraseña" aria-label="Contraseña" aria-describedby="authInput-addon">
                        </div>                   
                      </div>
                      <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="authCheck">
                        <label class="form-check-label" for="authCheck">Mantener Sesión Iniciada</label>
                    </div>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                  <button type="button" class="btn bg-softlogy">Ingresar</button>
                </div>
                </form>
              </div>
            </div>
